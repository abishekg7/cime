!===============================================================================
! SVN $Id: seq_infodata_mod.F90 65871 2014-12-01 16:11:53Z jedwards $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branches/sehires_exp/shr/seq_infodata_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!EOP
    ...
    namelist /seq_infodata_inparm/                            &
         aoflux_grid, aqua_planet, aqua_planet_sst,           &
         atm_gnam, bfbflag, brnch_retain_casename,            &
         budget_ann, budget_daily, budget_inst,               &
         budget_ltann, budget_ltend, budget_month,            &
         case_desc, case_name, cpl_decomp, cpl_seq_option,    &
         do_budgets, do_histinit, drv_threading, eps_aarea,   &
         eps_agrid, eps_amask, eps_frac, eps_oarea, eps_ogrid,&
         eps_omask, flux_albav, flux_epbal, force_stop_at,    &
         glc_gnam, histaux_a2x, histaux_a2x24hr,              &
         histaux_a2x3hr, histaux_a2x3hrp, histaux_l2x,        &
         histaux_r2x, hostname, ice_gnam, info_debug,         &
         lnd_gnam, logfilepostfix, max_cplstep_time,          &
         mct_usealltoall, mct_usevector, model_version,       &
         ocn_gnam, orb_eccen, orb_iyear, orb_iyear_align,     &
         orb_mode, orb_mvelp, orb_obliq, outpathroot,         &
         reprosum_diffmax, reprosum_recompute,                &
         reprosum_use_ddpdd, restart_file, rof_gnam,          &
         run_barriers, scmlat, scmlon, shr_map_dopole,        &
         single_column, start_type, tchkpt_dir,               &
         timing_dir, username, vect_map, wall_time_limit,     &
         wav_gnam
