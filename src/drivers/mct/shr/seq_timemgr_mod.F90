!===============================================================================
! SVN $Id: seq_timemgr_mod.F90 67242 2015-01-16 21:16:07Z sacks $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branches/sehires_exp/shr/seq_timemgr_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!EOP
    ...
    namelist /seq_timemgr_inparm/                        &
         atm_cpl_dt, atm_cpl_offset, calendar,           &
         end_restart, glc_cpl_dt, glc_cpl_offset,        &
         history_n, history_option, history_ymd,         &
         ice_cpl_dt, ice_cpl_offset, lnd_cpl_dt,         &
         lnd_cpl_offset, ocn_cpl_dt, ocn_cpl_offset,     &
         restart_n, restart_option, restart_ymd,         &
         rof_cpl_dt, start_tod, start_ymd, stop_n,       &
         stop_option, stop_ymd, tprof_n, tprof_option,   &
         tprof_ymd, wav_cpl_dt, wav_cpl_offset
